	...
	<div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active"
				 style="background-image: url('<?= base_url('assets/') ?>images/slider-01.jpg')">
		...
		<div class="row">
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-header"> HELVAN Contabilidade Consultoria e Auditória </h4>
			...
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-header"> HELVAN Hidro-Energias e Construção LDA </h4>
						<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse
							necessitatibus neque.</p>
					</div>
				</div>
			...
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-header"> HELVAN COMERCIO GERAL, LDA </h4>
						<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse
							necessitatibus neque.</p>
					</div>
				</div>
			...
			<div class="col-lg-4 mb-4">
				<div class="card h-100">
					<div class="card-body">
						<h4 class="card-header"> HELVAN-GASTER NOMOS RESTAURANTE </h4>
						<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse
							necessitatibus neque.</p>
					</div>
				</div>
				...
				<div class="card h-100">
					<div class="card-img">
						<a href="<?= base_url('assets/') ?>images/portfolio-img-01.jpg" data-fancybox="images">
							<img class="card-img-top" src="<?= base_url('assets/') ?>images/portfolio-img-01.jpg"
								 alt=""/>
				...
				<div class="card h-100">
					<div class="card-img">
						<a href="<?= base_url('assets/') ?>images/portfolio-img-02.jpg" data-fancybox="images">
							<img class="card-img-top" src="<?= base_url('assets/') ?>images/portfolio-img-02.jpg"
								 alt=""/>
							<div class="overlay"><i class="fas fa-arrows-alt"></i></div>
						</a>
					</div>
				...
				<div class="card h-100">
					<div class="card-img">
						<a href="<?= base_url('assets/') ?>images/portfolio-img-03.jpg" data-fancybox="images">
							<img class="card-img-top" src="<?= base_url('assets/') ?>images/portfolio-img-03.jpg"
								 alt=""/>
							<div class="overlay"><i class="fas fa-arrows-alt"></i></div>
						</a>
					</div>
				...
				<div class="card h-100">
					<div class="card-img">
						<a href="<?= base_url('assets/') ?>images/portfolio-img-04.jpg" data-fancybox="images">
							<img class="card-img-top" src="<?= base_url('assets/') ?>images/portfolio-img-04.jpg"
								 alt=""/>
							<div class="overlay"><i class="fas fa-arrows-alt"></i></div>
						</a>
					</div>
				...
				<div class="card h-100">
					<div class="card-img">
						<a href="<?= base_url('assets/') ?>images/portfolio-img-05.jpg" data-fancybox="images">
							<img class="card-img-top" src="<?= base_url('assets/') ?>images/portfolio-img-05.jpg"
								 alt=""/>
							<div class="overlay"><i class="fas fa-arrows-alt"></i></div>
						</a>
					</div>
